export const ACTION_TYPES = {
  ...
  gravityBack: 'gravityBack',
  gravityCubeLeft: 'gravityCubeLeft',
  gravityCubeRight: 'gravityCubeRight',
  gravityCubeTop: 'gravityCubeTop',
  gravityCubeBottom: 'gravityCubeBottom',
} as const
